...
contract MAPOmnichainServiceV2 is ReentrancyGuard, Initializable, Pausable, IMOSV2, UUPSUpgradeable {
    ...
    // record token can transferOut to which chain
    // toChainId => tokenAddress => enable
    ...
    function initialize(address _lightNode)
    public initializer checkAddress(_lightNode) {
