...
task("tokenGrant",
    ...
    .addOptionalParam("minter", "minter address, default relayservice", "mos", types.string)
...
task("tokenApprove",
    "Add approve to address",
    require("./tokenApprove")

)
    .addParam("token", "token address")
    .addOptionalParam("address", "default relayservice", "mos", types.string)
...
task("relayInit",
    "Initialize relayservice contract",
    require("./relayInit")
)
...
task("relayRegisterChain",
    "Register altchain relayservice to relay chain",
    require("./relayRegisterChain")
)
    .addParam("address", "relayservice contract address")
...
task("transferOutToken",
    ...
    .addParam("mos", "the relayservice address")
...
task("relayList",
    "List relayservice relay infos",
    require("./relayList")
)
    .addOptionalParam("relay", "The relayservice address, default relayservice", "relay", types.string)
...
task("mosList",
    ...
    .addOptionalParam("mos", "The relayservice address, default relayservice", "mos", types.string)
    .addOptionalParam("token", "The token address, default wtoken", "wtoken", types.string)
...
task("customData",
    ...
    .addOptionalParam("ctype", "The type of contract you want to execute(relayservice,relay,register)","relay",types.string)
...
)   .addOptionalParam("address", "The relayservice address, default relayservice", "address", types.string)
    .addOptionalParam("token", "The token address, default token", "token", types.string)