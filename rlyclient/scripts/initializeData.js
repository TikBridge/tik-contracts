...
let uri = process.env.ETH_API_RELAY_CHAIN_URI;
let epochLength = process.env.RELAY_CHAIN_EPOCH_LENGTH;
...
async function getdata() {
    ...
    let l = parseInt(epochLength)
    if (l < 1000) {
        console.error("epochLength should >= 1000")
        return null
    }
